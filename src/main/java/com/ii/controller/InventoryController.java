...
public class InventoryController {
	...
	@GetMapping("/Show-All-Items")
	public ResponseEntity<List<InventoryItem>> ShowAllInv() {
		return new ResponseEntity<List<InventoryItem>>(this.service.GetAllItems(), HttpStatus.FOUND);
	}
}
